...
def test_add_contact(app):
    added_contact = ContactConstruct(firstname="Max", lastname="Ryzhov", middlename="Nick", nickname="max_ryzh",
    ...
    assert sorted(old_contacts, key=ContactConstruct.id_or_max) == sorted(new_contacts, key=ContactConstruct.id_or_max)
